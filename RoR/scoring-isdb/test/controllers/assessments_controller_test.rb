...
class AssessmentsControllerTest < ActionController::TestCase
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post :create, assessment: { applicant_id: @assessment.applicant_id, category_id: @assessment.category_id, criterion_id: @assessment.criterion_id, grant_id: @assessment.grant_id, mark: @assessment.mark }
    end
  ...
  test "should update assessment" do
    patch :update, id: @assessment, assessment: { applicant_id: @assessment.applicant_id, category_id: @assessment.category_id, criterion_id: @assessment.criterion_id, grant_id: @assessment.grant_id, mark: @assessment.mark }
    assert_redirected_to assessment_path(assigns(:assessment))
  end
