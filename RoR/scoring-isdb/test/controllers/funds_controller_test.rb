...
class FundsControllerTest < ActionController::TestCase
  ...
  test "should create fund" do
    assert_difference('Fund.count') do
      post :create, fund: { fund_source_id: @fund.fund_source_id, percentage: @fund.percentage, proposal: @fund.proposal }
    end
  ...
  test "should update fund" do
    patch :update, id: @fund, fund: { fund_source_id: @fund.fund_source_id, percentage: @fund.percentage, proposal: @fund.proposal }
    assert_redirected_to fund_path(assigns(:fund))
  end
