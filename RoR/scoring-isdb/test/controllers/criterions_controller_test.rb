...
class CriterionsControllerTest < ActionController::TestCase
  ...
  test "should create criterion" do
    assert_difference('Criterion.count') do
      post :create, criterion: { category_id: @criterion.category_id, description: @criterion.description, is_active: @criterion.is_active }
    end
  ...
  test "should update criterion" do
    patch :update, id: @criterion, criterion: { category_id: @criterion.category_id, description: @criterion.description, is_active: @criterion.is_active }
    assert_redirected_to criterion_path(assigns(:criterion))
  end
